...
class SourceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_source = Category("Are hydrogen fuel cells the future of green transport? Sorta","Around the world, governments are implementing policies ..",
    ...
    def test_instance(self):
        self.assertTrue(isinstance(self.new_source,Category))
